...
public class ControleCarte10VoyagesR5Procedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BusutilitiesModItems.CARTE_DE_TRANSPORT_10_VOYAGES_R_5.get()) {
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(BusutilitiesModItems.CARTE_DE_TRANSPORT_10_VOYAGES_R_4.get());
				_setstack.setCount(1);
				ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
			}
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(BusutilitiesModItems.CARTE_DE_TRANSPORT_10_VOYAGES_R_5.get());
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("[Contr\u00F4le Bloc] : Carte 10 Voyage Valide - 4 Voyage Restant"), true);
