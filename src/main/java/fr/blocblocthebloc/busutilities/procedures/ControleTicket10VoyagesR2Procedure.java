...
public class ControleTicket10VoyagesR2Procedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BusutilitiesModItems.TICKET_10_VOYAGES_R_2.get()) {
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(BusutilitiesModItems.TICKET_10_VOYAGES_R_1.get());
				_setstack.setCount(1);
				ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
			}
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(BusutilitiesModItems.TICKET_10_VOYAGES_R_2.get());
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("[Contr\u00F4le Bloc] : Ticket 10 Voyage Valide - 1 Voyage Restant"), true);
