...
public class ControleCarteEssentielR1Procedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BusutilitiesModItems.CARTE_DE_TRANSPORT_ESSENTIEL_R_1.get()) {
			...
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(BusutilitiesModItems.CARTE_DE_TRANSPORT_ESSENTIEL_R_1.get());
