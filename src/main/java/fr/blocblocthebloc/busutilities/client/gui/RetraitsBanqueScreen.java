...
public class RetraitsBanqueScreen extends AbstractContainerScreen<RetraitsBanqueMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.busutilities.retraits_banque.label_bab"), 77, 5, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.retraits_banque.label_retraits_de_fonds"), 43, 19, -12829636);
	}
