...
public class DepotsBanqueScreen extends AbstractContainerScreen<DepotsBanqueMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.busutilities.depots_banque.label_bab"), 77, 5, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.busutilities.depots_banque.label_retraits_de_fonds"), 46, 19, -12829636, false);
	}
