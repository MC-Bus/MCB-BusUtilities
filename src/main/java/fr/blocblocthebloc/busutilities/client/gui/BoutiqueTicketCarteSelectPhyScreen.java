...
public class BoutiqueTicketCarteSelectPhyScreen extends AbstractContainerScreen<BoutiqueTicketCarteSelectPhyMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_carte_select_phy.label_boutique_de_tickets"), 37, 5, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_carte_select_phy.label_et_cartes"), 61, 16, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_carte_select_phy.label_passer_en_paiement_bancaire"), 17, 118, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_carte_select_phy.label_pour_acheter_des_cartes"), 27, 128, -12829636);
	}
