...
public class BoutiqueTicketPhyScreen extends AbstractContainerScreen<BoutiqueTicketPhyMenu> {
	private final static HashMap<String, Object> guistate = BoutiqueTicketPhyMenu.guistate;
	...
	public BoutiqueTicketPhyScreen(BoutiqueTicketPhyMenu container, Inventory inventory, Component text) {
	...
	public void init() {
		super.init();
		button_ticket_1_voyage = Button.builder(Component.translatable("gui.busutilities.boutique_ticket_phy.button_ticket_1_voyage"), e -> {
			if (true) {
				BusutilitiesMod.PACKET_HANDLER.sendToServer(new BoutiqueTicketPhyButtonMessage(0, x, y, z));
				BoutiqueTicketPhyButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		...
		button_ticket_3_voyages = Button.builder(Component.translatable("gui.busutilities.boutique_ticket_phy.button_ticket_3_voyages"), e -> {
			if (true) {
				BusutilitiesMod.PACKET_HANDLER.sendToServer(new BoutiqueTicketPhyButtonMessage(1, x, y, z));
				BoutiqueTicketPhyButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		...
		button_ticket_10_voyages = Button.builder(Component.translatable("gui.busutilities.boutique_ticket_phy.button_ticket_10_voyages"), e -> {
			if (true) {
				BusutilitiesMod.PACKET_HANDLER.sendToServer(new BoutiqueTicketPhyButtonMessage(2, x, y, z));
				BoutiqueTicketPhyButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
