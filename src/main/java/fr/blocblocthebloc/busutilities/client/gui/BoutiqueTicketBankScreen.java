...
public class BoutiqueTicketBankScreen extends AbstractContainerScreen<BoutiqueTicketBankMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_bank.label_boutique_de_tickets"), 39, 4, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_bank.label_ticket_1_voyage_1_b"), -116, 121, -39322);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_bank.label_ticket_3_voyages_4_b"), -118, 142, -205);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_bank.label_ticket_10_voyages_11b"), -121, 163, -16750849);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_bank.label_bienvenue"), 61, -33, -1);
		this.font.draw(poseStack,

				InfoBAB0Procedure.execute(entity), 69, -21, -1);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_bank.label_vous_avez"), 207, 59, -1);
		this.font.draw(poseStack,

				InfoBAB1Procedure.execute(entity), 217, 74, -1);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.boutique_ticket_bank.label_blokos"), 221, 92, -1);
	}
