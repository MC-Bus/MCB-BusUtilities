...
public class BanqueablokosScreen extends AbstractContainerScreen<BanqueablokosMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.busutilities.banqueablokos.label_bab"), 77, 5, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.banqueablokos.label_banque_a_blokos"), 46, 16, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.banqueablokos.label_bonjour"), 67, 37, -12829636);
		this.font.draw(poseStack,

				InfoBAB0Procedure.execute(entity), 67, 51, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.banqueablokos.label_vous_avez"), 57, 104, -12829636);
		this.font.draw(poseStack,

				InfoBAB1Procedure.execute(entity), 72, 120, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.busutilities.banqueablokos.label_blokos1"), 70, 135, -12829636);
	}
