...
import fr.blocblocthebloc.busutilities.item.LigneHItemItem;
import fr.blocblocthebloc.busutilities.item.LigneGItemItem;
import fr.blocblocthebloc.busutilities.item.LigneFItemItem;
import fr.blocblocthebloc.busutilities.item.LigneEItemItem;
import fr.blocblocthebloc.busutilities.item.LigneDItemItem;
import fr.blocblocthebloc.busutilities.item.LigneDEItemItem;
import fr.blocblocthebloc.busutilities.item.LigneCItemItem;
import fr.blocblocthebloc.busutilities.item.LigneCEItemItem;
import fr.blocblocthebloc.busutilities.item.LigneBItemItem;
import fr.blocblocthebloc.busutilities.item.LigneBEItemItem;
import fr.blocblocthebloc.busutilities.item.LigneAItemItem;
import fr.blocblocthebloc.busutilities.item.LigneAEItemItem;
...
public class BusutilitiesModItems {
	...
	public static final RegistryObject<Item> BOUTIQUE_CARTE_DE_TRANSPORT = block(BusutilitiesModBlocks.BOUTIQUE_CARTE_DE_TRANSPORT);
	...
	public static final RegistryObject<Item> LIGNE_A_BLOC = block(BusutilitiesModBlocks.LIGNE_A_BLOC);
	public static final RegistryObject<Item> LIGNE_B_BLOC = block(BusutilitiesModBlocks.LIGNE_B_BLOC);
	public static final RegistryObject<Item> LIGNE_CBLOC = block(BusutilitiesModBlocks.LIGNE_CBLOC);
	public static final RegistryObject<Item> LIGNE_D_BLOC = block(BusutilitiesModBlocks.LIGNE_D_BLOC);
	public static final RegistryObject<Item> LIGNE_E_BLOC = block(BusutilitiesModBlocks.LIGNE_E_BLOC);
	public static final RegistryObject<Item> LIGNE_F_BLOC = block(BusutilitiesModBlocks.LIGNE_F_BLOC);
	public static final RegistryObject<Item> LIGNE_G_BLOC = block(BusutilitiesModBlocks.LIGNE_G_BLOC);
	public static final RegistryObject<Item> LIGNE_H_BLOC = block(BusutilitiesModBlocks.LIGNE_H_BLOC);
	public static final RegistryObject<Item> LIGNE_AE_BLOC = block(BusutilitiesModBlocks.LIGNE_AE_BLOC);
	public static final RegistryObject<Item> LIGNE_BE_BLOC = block(BusutilitiesModBlocks.LIGNE_BE_BLOC);
	public static final RegistryObject<Item> LIGNE_CE_BLOC = block(BusutilitiesModBlocks.LIGNE_CE_BLOC);
	public static final RegistryObject<Item> LIGNE_DE_BLOC = block(BusutilitiesModBlocks.LIGNE_DE_BLOC);
	public static final RegistryObject<Item> LIGNE_A_ITEM = REGISTRY.register("ligne_a_item", () -> new LigneAItemItem());
	public static final RegistryObject<Item> LIGNE_B_ITEM = REGISTRY.register("ligne_b_item", () -> new LigneBItemItem());
	public static final RegistryObject<Item> LIGNE_C_ITEM = REGISTRY.register("ligne_c_item", () -> new LigneCItemItem());
	public static final RegistryObject<Item> LIGNE_D_ITEM = REGISTRY.register("ligne_d_item", () -> new LigneDItemItem());
	public static final RegistryObject<Item> LIGNE_E_ITEM = REGISTRY.register("ligne_e_item", () -> new LigneEItemItem());
	public static final RegistryObject<Item> LIGNE_F_ITEM = REGISTRY.register("ligne_f_item", () -> new LigneFItemItem());
	public static final RegistryObject<Item> LIGNE_G_ITEM = REGISTRY.register("ligne_g_item", () -> new LigneGItemItem());
	public static final RegistryObject<Item> LIGNE_H_ITEM = REGISTRY.register("ligne_h_item", () -> new LigneHItemItem());
	public static final RegistryObject<Item> LIGNE_AE_ITEM = REGISTRY.register("ligne_ae_item", () -> new LigneAEItemItem());
	public static final RegistryObject<Item> LIGNE_BE_ITEM = REGISTRY.register("ligne_be_item", () -> new LigneBEItemItem());
	public static final RegistryObject<Item> LIGNE_CE_ITEM = REGISTRY.register("ligne_ce_item", () -> new LigneCEItemItem());
	public static final RegistryObject<Item> LIGNE_DE_ITEM = REGISTRY.register("ligne_de_item", () -> new LigneDEItemItem());
